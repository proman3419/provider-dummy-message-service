# ====================================================================================
# Setup Project
PROJECT_NAME := provider-dummymessageservice
...
IMAGES = provider-dummymessageservice
...
XPKGS = provider-dummymessageservice
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-dummymessageservice: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider DummyMessageService CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider DummyMessageService controllers
...
# This target prepares repo for your provider by replacing all "dummymessageservice"
